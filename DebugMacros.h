...
#define DRAW_SPHERE_TIMED(Location, Color) if(GetWorld()) DrawDebugSphere(GetWorld(), Location, 8.f, 12, Color, false, 5.f);
...
#define DRAW_BOX(Center, Extent) if(GetWorld())  DrawDebugBox(GetWorld(), Center, Extent, FColor::Red, true);
